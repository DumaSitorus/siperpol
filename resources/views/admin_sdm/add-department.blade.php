            ...
            <div class="flex flex-wrap mt-6 -mx-3">
                <div class="w-full px-3 mb-6 lg:mb-0 lg:w-1/2 lg:flex-none">
                    <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                        <h5 class="pt-2 mt-4 font-bold text-center">DAFTAR SATUAN/BAGIAN TERDAFTAR</h5>
                    <div class="flex-auto p-4">
                        <form action="{{ route('add-department') }}" method="POST">
                            @csrf
                            <div id="departments-wrapper">
                                <div class="department-input flex mb-2">
                                    <input type="text" name="departments[]" class="border p-2 w-full rounded-md border-gray-300" placeholder="Nama Departemen" required>
                            ...
                            <button type="button" id="add-department" class="bg-sky-500 text-white px-3 py-1 mt-2 rounded-md">Tambah Satuan/Bagian</button>
                        ...
                        <div class="p-0 overflow-x-auto">
                            <table class=" items-center w-full  align-top border-gray-200 text-slate-500">
                                <thead class="align-bottom">
                                    ...
                                    <th class="py-3 font-medium text-semibold text-left uppercase align-middle bg-gray-50 border-b border-gray-200 shadow-none border-b-solid tracking-none whitespace-nowrap text-slate-500">Nama Satuan/Bagian</th>
                                    </tr>
                                </thead>
                            <tbody>
