            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                <nav>
                    ...
                    <li class="leading-normal text-sm">
                        <a class="opacity-50 text-slate-700">Monitor Anggota</a>
                    </li>
                    <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['>']" aria-current="page">Permohonan Anggota</li>
                    </ol>
                ...
                <!-- Card Search -->
                    <div class="flex-none w-full max-w-full px-3">
                        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                            ...
                            <h6 class="mb-2 text-xl text-center font-bold">Riwayat Pengajuan Cuti/Izin Anggota</h6>
                            </div>
