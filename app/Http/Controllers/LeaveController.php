...
class LeaveController extends Controller
{
    ...
    public function create_leave() : View
    {
        //
        $leave_types = LeaveType::get();
        $leaves = Leave::get();
        ...
        return view('admin_sdm.leaves-req-form', compact('users','leaves', 'leave_types'));
    }
    ...
    public function store_leave(Request $request) {
        ...
        if (!$user) {
            return redirect()->back()->withErrors(['nrp' => 'Nomor NRP tidak ditemukan'])->withInput();
        }
        ...
        Leave::create($data);
        return redirect()->to('leave-request/history')->with('success', 'Berhasil menambahkan cuti/izin');
    }
