        ...
        <div class="w-full px-6 mx-auto">
            ...
            <div class="relative flex flex-col flex-auto min-w-0 p-4 mx-6 -mt-16 overflow-hidden break-words border-0 shadow-blur rounded-2xl bg-white/80 bg-clip-border backdrop-blur-2xl backdrop-saturate-200">
                ...
                <div class="flex-none w-auto max-w-full px-3 my-auto">
                    <div class="h-full">
                    <h5 class="mb-1">{{ $users->pangkat }}</h5>
                    <p class="mb-0 font-semibold leading-normal text-md">{{ $users->name }}</p>
                    </div>
                </div>
        ...
        <div class="w-full p-6 mx-auto">
            <div class="flex flex-wrap justify-center">
                ...
                <div class="w-full max-w-full px-3 mt-4 xl:w-8/12">
                    <div class="relative flex flex-col h-full min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                        <div class="p-4 pb-0 mb-0 bg-white border-b-0 rounded-2xl">
                            <h6 class="mb-0 text-center text-lg font-semibold ">Informasi Cuti/Izin Pengguna</h6>
                            <hr class="h-px my-4 bg-transparent bg-gradient-to-r from-transparent via-white to-transparent" />
                                  ...
                                  <table class=" items-center w-full -mb-2 align-top border-gray-200 text-slate-500">
                                    <thead class="align-bottom">
                                      <tr>
                                        ...
                                        <th class="py-3 font-medium text-semibold text-left uppercase align-middle bg-gray-50 border-b border-gray-200 shadow-none border-b-solid tracking-none whitespace-nowrap text-slate-500">Jenis Cuti/Izin</th>
